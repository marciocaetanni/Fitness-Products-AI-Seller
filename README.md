...
We're using VSCode with Quarto, but you can choose your prefirable code editor.

So, in that case, we need to install the Quarto extension in VSCode.

All of the following explanation and details of the project you'll find on the Quarto file.